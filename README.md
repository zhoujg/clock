...
- **打字练习** ⌨️：
  - 英语单词打字练习，通过键盘输入记忆单词
  - **键盘练习模式**：专为初学者设计，从零开始学打字
  - 支持基础词汇、CET-4、CET-6 等多个词库
  - 实时输入验证和语音朗读
  - 显示音标和中文释义
  - WPM 速度统计和准确率分析
  - Apple 风格界面设计
  - [快速开始 →](./TYPING_PRACTICE_QUICK_START.md)
  - [键盘练习指南 →](./KEYBOARD_PRACTICE_GUIDE.md)
  - [插件说明 →](./plugins/typing-practice/README.md)
- **动画线条**：可开关的动态背景线条动画效果
- **滴答声音**：可选的时钟滴答音效
- **背景自定义**：
  - 8 种预设颜色主题
